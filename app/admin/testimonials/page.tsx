        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl sm:text-5xl font-black text-white mb-2">
              Manage <span className="text-[#915EFF]">Testimonials</span>
            </h1>
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-secondary text-lg">Showcase client feedback and reviews</p>
          </div>
          <button
          ...
          <div className="bg-[#1d1836] rounded-2xl p-8 mb-8 border border-[#915EFF]/20 shadow-2xl">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-bold text-white mb-3 uppercase tracking-wider">Name</label>
                  <input
                    type="text"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-sm font-bold text-white mb-3 uppercase tracking-wider">Designation</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-bold text-white mb-3 uppercase tracking-wider">Company/Platform</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-bold text-white mb-3 uppercase tracking-wider">Link</label>
                  <input
                    type="url"
                    value={formData.link}
